function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    forEach(data.size, function(size) {
      out.w("<div class=\"main-preview\"><a href=\"" +
